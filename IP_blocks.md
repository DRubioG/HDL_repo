...
## [SDRAM Controller (AXI4)](https://github.com/ultraembedded/core_sdram_axi4)
...
## [AXI Parameter RAM](https://github.com/paulscherrerinstitute/axi_parameter_ram)
Parameter RAM that allows to easily exchange parameters between a softcore processor and EPICS

- Language: Verilog, VHDL

## [Slicer IP](https://github.com/DRubioG/Slicer_IP)
...
## [Lightweight AXI-4 DDR3 Controller](https://github.com/ultraembedded/core_ddr3_controller)
...
## [ListenToJESD204B: A Lightweight Open-SourceJESD204B IP Core for FPGA-Based Ultrasound Acquisition systems](https://github.com/pulp-bio/ListenToJESD)
...
## [FPGA Floating Point Division (Single Precision)](https://github.com/SnrNotHere16/FPGADivisionFloatingPoint)
...
## [Digital AM Radio Reception using Digital LVDS Inputs as 1-bit ADCs](https://github.com/dawsonjon/FPGA-radio)
Modern FPGAs have IO pins capable of differential signalling at rates greater than 1e9 bits/seconds. When configured as an input an LVDS input behaves as a very high speed comparator. In this application, the input is used as an RF ADC. It has a very low resolution of 1-bit, but the high bandwidth allows us to oversample audio signals, allowing us to regain the necessary resolution at audio bandwidths.

- Language: VHDL

## [FPGA-TX](https://github.com/dawsonjon/FPGA-TX)
FPGA-TX is an FPGA based radio transmitter, that can transmit at frequencies up to 400MHz. So far, FPGA-TX supports AM, FM, LSB, USB, Wideband FM, and Wideband FM Stereo.

- Language: Verilog


## [Transformer Accelerator Based on FPGA](https://github.com/Buck008/Transformer-Accelerator-Based-on-FPGA)
...
## [Image-Processing-IP-Design-for-Demosaic-on-FPGA](https://github.com/Buck008/Image-Processing-IP-Design-for-Demosaic-on-FPGA)
...
## [AFRL Simulator Stimulator for AXIS](https://github.com/johnathan-convertino-afrl/axis_stimulator)
AXIS Stimulator, create and write device under test data to and from a file.
